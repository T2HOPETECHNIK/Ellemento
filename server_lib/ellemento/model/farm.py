...
class Farm:
    ...
    def create_farm(id=-1, type_name=None):
        ...
        logger.info("Create phase 123 trays done")
        TrayFactory.create_phase4_trays()
        # TrayFactory.print()
        logger.info("Create phase 4 trays done")
        TrayFactory.create_phase5_trays()
        logger.info("Create phase 5 trays done")

        ShelfFactory.create_phase1_shelves()
        logger.info("Create phase 1 shelves done")
        ShelfFactory.create_phase2_shelves()
        logger.info("Create phase 2 shelves done")
        ShelfFactory.create_phase3_shelves()
        logger.info("Create phase 3 shelves done")
        ShelfFactory.create_phase4_shelves()
        logger.info("Create phase 4 shelves done")
        ShelfFactory.create_phase5_shelves()
        # ShelfFactory.print()
        logger.info("Create phase 5 shelves done")
