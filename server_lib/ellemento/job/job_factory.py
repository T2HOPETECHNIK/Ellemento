...
class JobFactory:
    ...
    def create_thread_jobs():
        ...
        # buffer_3_in_2_transplantor_job = threading.Thread(target=BufferToTransplantorJob.create_3_in_buffer_to_transplantor_job)
        # buffer_3_in_2_transplantor_job.start() 
        ...
        buffer_5_2_transplantor_job = threading.Thread(
            target=BufferToTransplantorJob.create_5_buffer_to_transplantor_job)
    ...
    def grow_plants_jobs():
        ...
        time.sleep(1)
        # -- Tested ----------------------------------------------------------------------------- 
        check_duration_phase1 = threading.Thread(target=TrayFactory.check_duration,
                                                 kwargs={'trays': Tray.all_trays, 'status': TrayStatus.PHASE1,
                                                         'unit': unit, 'duration': 3 * 20})
        check_duration_phase1.start()

        check_duration_phase2 = threading.Thread(target=TrayFactory.check_duration,
                                                 kwargs={'trays': Tray.all_trays, 'status': TrayStatus.PHASE2,
                                                         'unit': unit, 'duration': 4 * 20})
        check_duration_phase2.start()

        check_duration_phase3 = threading.Thread(target=TrayFactory.check_duration,
                                                 kwargs={'trays': Tray.all_trays, 'status': TrayStatus.PHASE3,
                                                         'unit': unit, 'duration': 7 * 20})
        check_duration_phase3.start()

        check_duration_phase4 = threading.Thread(target=TrayFactory.check_duration,
                                                 kwargs={'trays': Tray.all_trays, 'status': TrayStatus.PHASE4,
                                                         'unit': unit, 'duration': 7 * 20})
        check_duration_phase4.start()
        # --End of tested 

        check_duration_phase5 = threading.Thread(target=TrayFactory.check_duration,
                                                 kwargs={'trays': Tray.all_trays, 'status': TrayStatus.PHASE5,
                                                         'unit': unit, 'duration': 7 * 20})
    ...
    def create_jobs_phase123(type_name="Default", id=-1):
        ...
        logger.info("Transplanter to sower job is done")
    ...
    def create_jobs_phase4():
        ...
        # create transplanter to 4 out buffer job 
        # create 4 out buffer to phase 4 shelf job 
        # create phase 4 shelf to 4 in buffer job 
        # create 4 in buffer to transplanter job 
        # Transplanting job 
        # From transplanter to 4 buffer 
    ...
    def create_jobs_phase5():
        ...
        # create transfer job from transplanter to phase 5 shelf job
        # create phase 5 shelf to harvestor  
        # create 4 in buffer to transplanter job 
        # Transplanting job 
        # From transplanter to 5 buffer 
        # From 5 buffer to transplanter 
        # *********************************************************
